...
export const i18n_en = {
  ...
  present_yourself: 'Introduce yourself and ask for consent',
  ...
  female: 'Female',
  other: 'Other',
  hh_age_1: 'Member 1 (the respondent): age',
  ...
  hh_sex_1: 'Member 1 (the respondent): sex',
  ...
  what_is_the_sex_of_the_head_of_household: 'What is the sex of the head of household?',
  ...
  mother: 'Mother',
  father: 'Father',
  its_an_autocomplete: '🔎 Type in inputs to search...',
  other_relative: 'Other relative',
  you_indicate_no_children_in_hh: 'Nothing to fill because you indicated that there were no children < 18 in the household.',
  cannot_have_options_checked_together: 'Cannot have these options checked together.',
  where_is_your_partner: 'Where is your Partner?',
  ...
  insert_approximate: 'Insert approximate',
  ...
  are_you_and_your_hh_members_registered_as_idps: 'Are you and your HH members registered as IDPs?',
  ...
  leave_blank_if_none: 'Leave blank if unable/unwilling to answer',
  _1_very_unsafe: '1 - Very unsafe',
  _2_unsafe: '2 - Unsafe',
  _4_safe: '3 - Safe',
  _5_very_safe: '4 - Very safe',
  ...
  is_this_area_contaminated: 'Is this area contaminated?',
  is_this_area_contaminated_hint: 'E.g. landmines and/or UXOs',
  ...
  how_would_you_describe_the_relationship_between_member_of_the_host_community: 'How would you describe the relationship between members of the host community, IDPs and/or returnees in this location?',
  ...
  do_you_or_your_household_members_experience_any_barriers_to_movements_in_and_around_the_area_DELETE: 'Do you or your household members experience any barriers to movements in and around the area?',
  ...
  what_is_the_average_month_income_per_household: 'What is the average monthly income per household?',
  ...
  are_there_gaps_in_meeting_your_basic_needs: 'Are there gaps in meeting your basic needs?',
  are_there_gaps_in_meeting_your_basic_needs_hint: 'Needs required to maintain a sustainable existence in the short term',
  yes_a_lot: 'Yes a lot',
  ...
  are_schoolaged_children_in_your_household_regularly_attending_primary_or_secondary_education: 'Are school-aged children (aged 6 to 15) in your household regularly attending primary or secondary education?',
  ...
  what_is_your_current_housing_structure: 'What is your current accommodation structure ?',
  ...
  partially_damaged_destroyed: 'Partially damaged/destroyed',
  severely_damaged_destroyed: 'Severely damaged/destroyed',
